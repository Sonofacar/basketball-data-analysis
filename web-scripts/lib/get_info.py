...
class game_data(game_info):
    ...
    def player_data(self):
        ...
        output = {'Seconds': self.player_to_seconds(tmp_table['MP']).astype(int).abs(),
                  ...
                  'Two_Attempts': tmp_table['FGA'].astype(int).abs(),
                  'Freethrows': tmp_table['FT'].astype(int).abs(),
                  'Freethrow_Attempts': tmp_table['FTA'].astype(int).abs(),
                  'Offensive_Rebounds': tmp_table['ORB'].astype(int).abs(),
                  'Deffensive_Rebounds': tmp_table['DRB'].astype(int).abs(),
                  'Assists': tmp_table['AST'].astype(int).abs(),
                  'Steals': tmp_table['STL'].astype(int).abs(),
                  'Blocks': tmp_table['BLK'].astype(int).abs(),
                  'Turnovers': tmp_table['TOV'].astype(int).abs(),
                  'Fouls': tmp_table['PF'].astype(int).abs(),
                  'Points': tmp_table['PTS'].astype(int).abs(),
                  'PM': tmp_table['PM'],
