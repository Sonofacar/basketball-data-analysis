...
class game_data(game_info):
    ...
    def player_data(self):
        ...
        output = {'Seconds': self.player_to_seconds(tmp_table['MP']).abs(),
                  'Field_Goals': tmp_table['FG'].abs(),
                  'Field_Goal_Attempts': tmp_table['FGA'].abs(),
                  'Threes': tmp_table['3P'].abs(),
                  'Three_Attempts': tmp_table['3PA'].abs(),
                  'Twos': tmp_table['FG'].abs(),
                  'Two_Attempts': tmp_table['FGA'].abs(),
                  'Freethrows': tmp_table['FT'].abs(),
                  'Freethrow_Attempts': tmp_table['FTA'].abs(),
                  'Offensive_Rebounds': tmp_table['ORB'].abs(),
                  'Deffensive_Rebounds': tmp_table['DRB'].abs(),
                  'Assists': tmp_table['AST'].abs(),
                  'Steals': tmp_table['STL'].abs(),
                  'Blocks': tmp_table['BLK'].abs(),
                  'Turnovers': tmp_table['TOV'].abs(),
                  'Fouls': tmp_table['PF'].abs(),
                  'Points': tmp_table['PTS'].abs(),
                  'PM': tmp_table['PM'],
    ...
    def player_data_quarter(self):
        ...
        output = {'Quarter': tmp_table.Quarter,
                  'Seconds': self.player_to_seconds(tmp_table['MP']).abs(),
                  'Field_Goals': tmp_table['FG'].abs(),
                  'Field_Goal_Attempts': tmp_table['FGA'].abs(),
                  'Threes': tmp_table['3P'].abs(),
                  'Three_Attempts': tmp_table['3PA'].abs(),
    ...
    def team_data(self):
        Teams = [self.home_team_name(), self.away_team_name()]
        tmp_table = self.total_game[self.total_game.Name.str.contains('|'.join(Teams))]
        output = {'Total_Minutes': tmp_table['MP'].abs(),
                  'Field_Goals': tmp_table['FG'].abs(),
                  'Field_Goal_Attempts': tmp_table['FGA'].abs(),
                  'Threes': tmp_table['3P'].abs(),
                  'Three_Attempts': tmp_table['3PA'].abs(),
    ...
    def team_data_quarter(self):
        ...
        output = {'Quarter': tmp_table.Quarter,
                  'Total_Minutes': tmp_table['MP'].abs(),
                  'Field_Goals': tmp_table['FG'].abs(),
                  'Field_Goal_Attempts': tmp_table['FGA'].abs(),
                  'Threes': tmp_table['3P'].abs(),
                  'Three_Attempts': tmp_table['3PA'].abs(),
