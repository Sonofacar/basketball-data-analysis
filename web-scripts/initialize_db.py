...
playoff_game_info = '''CREATE TABLE IF NOT EXISTS playoff_game_info(
Home_Team_Name TEXT,
Away_Team_Name TEXT,
Date TEXT,
Location TEXT,
...
cur.execute(team_games_playoffs)
cur.execute(team_quarters_playoffs)
cur.execute(player_info)
cur.execute(player_games)
cur.execute(player_quarters)
cur.execute(player_games_playoffs)
cur.execute(player_quarters_playoffs)
cur.execute(seasons)
