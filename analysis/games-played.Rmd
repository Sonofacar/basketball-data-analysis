...
ggplot(data) +
	geom_density(aes(x = Next_Season_Not_Played), fill = 'darkgreen') +
	theme_classic()
```
...
make_plot <- function(column) {
	output <- ggplot(data) +
		geom_point(aes(y = Next_Season_Not_Played, x = .data[[column]]), position = 'jitter') +
		scale_y_sqrt() +
		ylab('Not Played') +
		theme_classic()
	return(output)
}
MP_plot <- make_plot("MP")
Not_Played_plot <- make_plot("Not_Played")
Avg_MP_plot <- make_plot("Avg_MP")
Age_plot <- make_plot("Age")
Avg_Usage_plot <- make_plot("Avg_Usage")
Touches_plot <- make_plot("Touches")
team_Pace_plot <- make_plot("team_Pace")
Inj_pct_plot <- make_plot("Inj_pct")
Avg_O_Rating_plot <- make_plot("Avg_O_Rating")
Avg_D_Rating_plot <- make_plot("Avg_D_Rating")
O_W_shares_plot <- make_plot("O_W_shares")
D_W_shares_plot <- make_plot("D_W_shares")
PIE_sum_plot <- make_plot("PIE_sum")
Avg_GmSc_plot <- make_plot("Avg_GmSc")
Not_Played_two_back_plot <- make_plot("Not_Played_two_back")
MP_two_back_plot <- make_plot("MP_two_back")
Avg_MP_two_back_plot <- make_plot("Avg_MP_two_back")
Inj_pct_two_back_plot <- make_plot("Inj_pct_two_back")
PIE_sum_two_back_plot <- make_plot("PIE_sum_two_back")
Avg_GmSc_two_back_plot <- make_plot("Avg_GmSc_two_back")
Not_Played_three_back_plot <- make_plot("Not_Played_three_back")
MP_three_back_plot <- make_plot("MP_three_back")
Avg_MP_three_back_plot <- make_plot("Avg_MP_three_back")
Inj_pct_three_back_plot <- make_plot("Inj_pct_three_back")
PIE_sum_three_back_plot <- make_plot("PIE_sum_three_back")
Avg_GmSc_three_back_plot <- make_plot("Avg_GmSc_three_back")
(MP_plot | Not_Played_plot | Avg_MP_plot | Age_plot) /
(Avg_Usage_plot | Touches_plot | team_Pace_plot | Inj_pct_plot) /
(Avg_O_Rating_plot | Avg_D_Rating_plot | O_W_shares_plot | D_W_shares_plot) /
(PIE_sum_plot | Avg_GmSc_plot | Not_Played_two_back_plot | MP_two_back_plot) /
(Avg_MP_two_back_plot | Inj_pct_two_back_plot | PIE_sum_two_back_plot | Avg_GmSc_two_back_plot) /
(Not_Played_three_back_plot | MP_three_back_plot | Avg_MP_three_back_plot | Inj_pct_three_back_plot) /
(PIE_sum_three_back_plot | Avg_GmSc_three_back_plot)
```
