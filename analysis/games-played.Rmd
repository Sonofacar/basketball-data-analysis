...
| Games_two_back      | Number of games played two seasons ago                                          |
...
| Games_three_back    | Number of games played three seasons ago                                        |
...
| Next_Season_Games   | Number of games played in the season of interest                                |

To be clear, our response variable is a count that is distributed as such:

```{r}
ggplot(data) +
	geom_density(aes(x = Next_Season_Games), fill = 'darkgreen') +
	theme_classic()
```

This appears to be a negative binomial distribution,
